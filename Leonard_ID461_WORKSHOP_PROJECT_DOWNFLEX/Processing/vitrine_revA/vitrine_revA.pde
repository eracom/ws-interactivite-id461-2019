...
void display() {
  ...
  processCursor = int(map(Cursor,830,9000,0,480)); // modification de la valeur donnée par le capteur 
...
void loadFile() { //fonction de chargement des images
  for (int i = 0; i<imageCount; i ++) {
    listeDimages.add(loadImage("images/COVER_"+nf(i, 5)+".png"));   // charger les images du dossier images se nommant left + normalisation à 4 numero + .png
